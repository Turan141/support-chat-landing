	...
	const features = [
		{
			...
			visual: (
				<div className="relative h-full w-full bg-slate-900 rounded-3xl p-5 md:p-8 overflow-hidden flex flex-col justify-between min-h-[320px]">
					...
					<div className="relative z-10">
						<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-medium mb-4 md:mb-6">
							<Bot className="w-3 h-3" /> AI Powered
						</div>
						<h4 className="text-xl md:text-2xl font-bold text-white mb-2">Smart Auto-Responses</h4>
						<p className="text-slate-400 text-sm">The AI learns from your history.</p>
					</div>

					<div className="space-y-3 md:space-y-4 relative z-10 mt-6 md:mt-8">
						<div className="flex gap-3 md:gap-4">
							<div className="w-8 h-8 rounded-full bg-slate-700 flex-shrink-0"></div>
							<div className="bg-slate-800 rounded-2xl rounded-tl-none p-3 md:p-4 max-w-[85%] border border-slate-700">
								<div className="h-2 w-24 md:w-32 bg-slate-600 rounded mb-2"></div>
								<div className="h-2 w-32 md:w-48 bg-slate-600 rounded"></div>
							</div>
						</div>
						<div className="flex gap-3 md:gap-4 flex-row-reverse">
							...
							<div className="bg-blue-600 text-white rounded-2xl rounded-tr-none p-3 md:p-4 max-w-[85%] shadow-lg shadow-blue-900/20">
								<p className="text-xs md:text-sm font-medium leading-relaxed">Based on your knowledge base, here is the solution...</p>
							</div>
						</div>
					</div>
				</div>
		...
		},
		{
			...
			visual: (
				<div className="relative h-full w-full bg-white border border-slate-200 rounded-3xl p-4 md:p-8 overflow-hidden flex items-center justify-center bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] [background-size:16px_16px]">
					<div className="relative z-10 bg-white p-4 md:p-6 rounded-2xl shadow-2xl border border-slate-100 w-full max-w-sm">
						<div className="flex items-center gap-4 mb-6">
							<div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-lg md:text-xl border-4 border-white shadow-sm">
								JD
							</div>
							<div>
								<div className="font-bold text-slate-900 text-base md:text-lg">John Doe</div>
		...
		},
		{
			...
			visual: (
				<div className="relative h-full w-full bg-slate-50 rounded-3xl p-4 md:p-6 overflow-hidden flex flex-col">
					...
					<div className="grid grid-cols-2 gap-3 md:gap-4 mb-6">
						<div className="bg-white p-3 md:p-4 rounded-2xl shadow-sm border border-slate-100">
							...
							<div className="text-xl md:text-2xl font-bold text-slate-900">1,234</div>
						...
						<div className="bg-white p-3 md:p-4 rounded-2xl shadow-sm border border-slate-100">
							...
							<div className="text-xl md:text-2xl font-bold text-slate-900">1m 30s</div>
							<div className="text-xs text-green-600 flex items-center gap-1 mt-1">
